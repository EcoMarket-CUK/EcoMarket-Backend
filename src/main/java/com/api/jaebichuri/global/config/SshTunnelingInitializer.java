...
public class SshTunnelingInitializer {
    ...
    public Integer buildSshConnection(String url, int port) {

        Integer forwardedPort = null;

        try {
            log.info("{}@{}:{}:{} with privateKey", user, remoteJumpHost, sshPort, port);
            ...
            forwardedPort = session.setPortForwardingL(0, url, port);
